...
const suites = [
  ...
  'test-native-guards.ts', 'test-kev.ts', 'test-screen.ts', 'test-desktop-lib.ts', 'test-builtin-downloads.ts', 'test-auth.ts', 'test-installation.ts', 'test-reach.ts', 'test-devices.ts', 'test-verification.ts', 'test-pause.ts', 'test-rules-for-actor.ts',
