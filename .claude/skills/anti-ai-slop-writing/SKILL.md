...
Load the banned words and phrases list from `references/banned-words.md`. Never use any word or phrase on that list. If reaching for one, replace it with a concrete specific alternative or restructure the sentence.
...
No thread-emoji or "Thread:" openers. Content should make people want to keep reading on its own.
...
- What platform is this for? Cover letter is not a tweet is not LinkedIn is not a DM.
